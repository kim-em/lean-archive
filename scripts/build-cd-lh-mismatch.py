...
# Archive/Zip.lean:170-171).  The CD itself contains one
...
# guard at Archive/Zip.lean:1106 — *"bad local header signature for {label}"*
...
# `Archive.extract` at Archive/Zip.lean:1269 / :1273 caught only the
...
# literally as `0x0800` at Archive/Zip.lean:91 (LH) and :118 (CD), so
...
# names) keeps the UTF-8-name guard at Archive/Zip.lean:634 happy so
...
# consistency check (PR #1715, Archive/Zip.lean:1172) does not fire
