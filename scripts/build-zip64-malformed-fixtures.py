...
# the `cdSize` sub-check at [Archive/Zip.lean:396] is the one that
...
# sub-check at [Archive/Zip.lean:402] is the one that trips.  Closes
...
# `diskWhereCDStarts` sub-check at [Archive/Zip.lean:408] is the one
...
# [Archive/Zip.lean:411] is the one that trips.  Closes the per-slot
